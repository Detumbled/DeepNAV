...
constexpr double kArcDurationSec = 30.0 * 24.0 * 3600.0;
constexpr double kCadenceSec = 120.0;
constexpr double kVLBICadenceSec = 60.0;
constexpr std::size_t kMinVLBISamplesPerBaseline = 20;
constexpr double kElevationMaskDeg = 10.0;
constexpr double kRangeSigmaKm = 0.010; //Default value: 0.010 km
constexpr double kRangeRateSigmaKmPerSec = 1.0e-6; //Default value: 1.0e-6 km/s
constexpr double kVLBISigmaKm =  0.001; //Default value: 0.001 km
